...
#define MYADDRESS   			5					// your address choice (table number) - That is station 6
#define MAX_BLOCK_SIZE 		255				// size max for a frame (#bytes)
...
extern osMessageQueueId_t queue_macWaitToken_id;
//--------------------------------------------------------------------------------
